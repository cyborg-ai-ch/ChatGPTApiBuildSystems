...
from utils.functions import get_completion_from_messages, get_products_and_category
...
products_and_category = get_products_and_category("show me all categories and products")
