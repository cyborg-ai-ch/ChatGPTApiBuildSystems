...
from utils.functions import find_category_and_product_only, read_string_to_list, get_completion_from_messages, \
    get_products_and_category, answer_user_msg
...
products_by_category = get_products_and_category(customer_msg)
category_and_product_list = read_string_to_list(products_by_category)
product_info = find_category_and_product_only(category_and_product_list)
