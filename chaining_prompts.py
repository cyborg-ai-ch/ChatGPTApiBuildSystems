...
# -------------------------------------------
# User is asking about products and categories. In my option not a common use case, in common he ask about
# a category and what product are available and how they compare in function and price.
user_message_1 = f"""
...
# -------------------------------------------
# Cant find category nor product list is empty
user_message_2 = f"""
